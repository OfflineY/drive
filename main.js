   ...
   */
   window.GLOBAL_CONFIG = {
    SCF_GATEWAY: "https://two.yuandrive.workers.dev/",
    SITE_NAME: "DRIVE",
    IS_CF: true,
  };
      ...
      elem.addEventListener("click", (event) => {
        ...
        switch (contentType) {
          ...
          default:
            ...
            textWrapper.innerHTML = "<br><br><ion-icon class='sorry' name='sad'></ion-icon><br>抱歉，该文件不支持预览";
            content.innerHTML = "";
        ...
        document
          ...
          .addEventListener("click", (event) => {
            ...
            btn.innerHTML = "已复制文件链接";
            setTimeout(() => (btn.innerHTML = "<i class='material-icons'>attachment</i> 引用"), 2000);
          });
        document
          ...
          .addEventListener("click", (event) => {
            ...
            btn.innerHTML = "已复制文件夹链接";
            setTimeout(() => (btn.innerHTML = "<ion-icon name='share-social'></ion-icon> 分享"), 2000);
          });
